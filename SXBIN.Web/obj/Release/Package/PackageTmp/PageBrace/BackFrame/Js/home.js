$(function () {
	...
	//加载第一个tabs
	addTab(index_lang_desktop, "/Administrator/Desktop", "fa fa-home");
...
function loadTreeMenu(parentId, name)
{
	$(".bannerMenu").removeClass("selected");
	$("#" + parentId).addClass("selected");

	$.post("/api/System/GetTreeByEasyui/" + parentId, {
		"id": parentId
	}, //获取第一层目录
	...
	function (data) {
		...
		$("#RightTree").tree({
			...
			onBeforeExpand: function (node, param) {
				$("#RightTree").tree('options').url = "/api/System/GetTreeByEasyui/" + node.id;
			},
